...
def generate(
    model, input_ids, past_key_values, max_new_tokens, activate_timing, verbose=True
):
...
def main():
    ...
    model.forward = torch.compile(
        model.forward, mode="max-autotune", dynamic=False, fullgraph=True
    )
    #####################################
